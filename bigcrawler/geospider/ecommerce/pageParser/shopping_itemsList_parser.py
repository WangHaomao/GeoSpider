...
def analysis_json_data(url, soup):
    ...
    for li in res_dic:
        for key, value in li.items():
            ...
            elif ("img" in key or 'pic' in key or ".jpg" in value or '.png' in value):
                print value
...
if __name__ == '__main__':
    ...
    #
    # soup = get_soup_by_request("https://s.taobao.com/list?q=%E7%BE%BD%E7%BB%92%E6%9C%8D&bcoffset=12&s=3540")
    # print analysis_json_data("https://s.taobao.com/list?q=%E7%BE%BD%E7%BB%92%E6%9C%8D&bcoffset=12&s=3540",soup)
